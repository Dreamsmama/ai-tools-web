...
_BEAUTY_INSTRUCTIONS: dict[str, str] = {
    "natural": "",
    "light": "在保留本人特征的前提下，轻微优化肤色和光线，让人物看起来更清爽自然。",
    "upgrade": "在保留本人特征的前提下，适度提升精神感和气质，优化肤色、光线和整体形象。",
}
...
def _build_prompt(style: str, beauty_level: str) -> str:
    ...
    parts = [style_desc, _PRESERVE_BASE]
    if beauty_instruction:
        parts.append(beauty_instruction)
    return "".join(parts)
