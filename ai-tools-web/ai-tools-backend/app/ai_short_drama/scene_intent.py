...
INTENT_VARIANTS: Dict[SceneIntent, List[VisualVariant]] = {
    "opening": [
        {
            ...
            "tags": ["opening", "subway", "commute", "morning"],
            "scene": "竖屏清晨地铁车厢，打工人通勤背影，城市晨光透过车窗，耳机，不要办公室室内",
            "ui": "竖屏通勤时间与天气小组件",
            "effects": "竖屏地铁轨道站台光影",
        },
        {
            ...
            "scene": "竖屏夜晚城市街道，路灯与行人剪影，写字楼远景虚化，不要室内",
            "ui": "竖屏天气与通勤时间小组件",
            "effects": "竖屏蓝调城市远景",
        },
        {
            "scene_key": "office_day",
            "tags": ["opening", "street", "coffee", "morning"],
            "scene": "竖屏写字楼附近街道，早高峰行人，手持咖啡杯剪影，城市背景虚化",
            "ui": "竖屏打卡软件今日排班界面",
            "effects": "竖屏清晨阳光街道",
        },
        {
    ...
    "communication": [
        {
            "scene_key": "office_night",
            "tags": ["communication", "subway", "phone_chat", "commute"],
            "scene": "竖屏地铁车厢里握着手机回复工作消息，耳机，疲惫通勤感，非办公室",
            "ui": "竖屏飞书/微信工作群消息列表",
            "props": "竖屏手机屏幕与地铁扶手特写",
        },
        {
            "scene_key": "office_day",
            "tags": ["communication", "street", "phone_call", "outdoor"],
            "scene": "竖屏楼道或公司门口接电话，城市背景虚化，非会议室内部",
            "ui": "竖屏通话记录界面",
            "props": "竖屏纸杯咖啡与手机",
        },
        {
            ...
            "scene": "竖屏会议室白板与便利贴一角，椅子侧影，不要横向全景",
            "ui": "竖屏在线文档协作界面，多人光标",
            "props": "竖屏马克笔与便签特写",
        },
        {
            ...
            "scene": "竖屏手机与耳机，屏幕聊天框虚化，非显示器大特写，生活感桌面",
            "ui": "竖屏飞书群聊列表，工作讨论语气",
            "props": "竖屏电话听筒与便签",
        },
        {
            "scene_key": "office_night",
            "tags": ["communication", "convenience_store", "late_night", "chat"],
            "scene": "竖屏深夜便利店角落，低头看手机屏幕，暖光，工作消息与外卖并存",
            "ui": "竖屏工作群消息与外卖倒计时并列",
            "props": "竖屏便利店饭团与手机",
        },
    ],
...
def infer_scene_intent(
    ...
    *,
    ...
    # 按段号轮换，避免全片单调落 communication
    _fallback_cycle = ["daily_life", "emotion", "communication", "fatigue", "daily_life"]
    return _fallback_cycle[segment_no % len(_fallback_cycle)]
...
def enrich_segment_with_scene_intent(
    ...
    *,
    ...
    llm_input = str(seg.get("sceneDescription") or "").strip()
    seg["sceneDescription"] = build_scene_description(
        ...
        segment_no=seg_no,
        total_segments=total_segments,
        llm_scene_description=llm_input,
        used_scene_keys=used_scene_keys,
        role_key=rk,
        career_cn=career_cn,
    )
    seg["sceneDescriptionSource"] = "llm" if (llm_input and len(llm_input) >= 10) else "fallback"
    return seg
